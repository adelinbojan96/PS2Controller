...
set_property -dict { PACKAGE_PIN T10   IOSTANDARD LVCMOS33 } [get_ports { ca[0] }];# IO_L24N_T3_A00_D16_14 Sch=ca[0]
set_property -dict { PACKAGE_PIN R10   IOSTANDARD LVCMOS33 } [get_ports { ca[1] }]; #IO_25_14 Sch=ca[1]
set_property -dict { PACKAGE_PIN K16   IOSTANDARD LVCMOS33 } [get_ports { ca[2] }];# IO_25_15 Sch=ca[2]
set_property -dict { PACKAGE_PIN K13   IOSTANDARD LVCMOS33 } [get_ports { ca[3] }]; #IO_L17P_T2_A26_15 Sch=ca[3]
set_property -dict { PACKAGE_PIN P15   IOSTANDARD LVCMOS33 } [get_ports { ca[4] }]; #IO_L13P_T2_MRCC_14 Sch=ca[4]
set_property -dict { PACKAGE_PIN T11   IOSTANDARD LVCMOS33 } [get_ports { ca[5] }]; #IO_L19P_T3_A10_D26_14 Sch=ca[5]
set_property -dict { PACKAGE_PIN L18   IOSTANDARD LVCMOS33 } [get_ports { ca[6] }]; #IO_L4P_T0_D04_14 Sch=ca[6]

set_property -dict { PACKAGE_PIN H15   IOSTANDARD LVCMOS33 } [get_ports { ca[7] }]; #IO_L19N_T3_A21_VREF_15 Sch=ca[7]
